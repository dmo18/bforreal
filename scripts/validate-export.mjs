...
for (const file of ["index.html", "404.html", ".nojekyll", "motto-reference.jpg", "motto-reference.webp", "living-yosh.webp"]) {
...
if (livingYosh.size < 5_000) throw new Error("Exported LivingYosh image is unexpectedly small");
